...
def create_dataset():
    ...
    #Dataset-id variable
    dataset_id = "andrii-edu-bigquery.airbnb_ds_new"
...
output_table_spec = 'andrii-edu-bigquery:airbnb_ds_new.airbnb_tb_new'
...
view_id = "andrii-edu-bigquery.airbnb_ds_new.airbnb_analysis_vw_new"
